...
export default function EmailCapture() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        console.log("Joined the herd:", email);
        setSubmitted(true);
    };
                ...
                {submitted ? (
                    ...
                    <div className="w-full max-w-md mx-auto">
                        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 w-full">
                            ...
                            <Button type="submit" size="lg" className="h-14 w-full sm:w-auto px-8 bg-white text-black hover:bg-white/90 font-bold uppercase tracking-wide">
                                Sign Up
                            </Button>
                        </form>
