            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
                ...
                <Card className="bg-card border-white/10 overflow-hidden group">
                    <div className="h-64 bg-neutral-800 relative flex items-center justify-center overflow-hidden">
                        {/* Static Map via Embed + no pointer events + CSS Crop to hide UI */}
                        <div className="absolute inset-0 w-[120%] h-[200%] -left-[10%] -top-[60%] pointer-events-none">
                            <iframe
                                width="100%"
                                height="100%"
                                frameBorder="0"
                                ...
                                src="https://maps.google.com/maps?q=Protective%20Stadium%2C%20Birmingham%2C%20AL&z=16&ie=UTF8&iwloc=&output=embed"
